                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <hr class="mb-2">
                                    <p class="card-text"><small class="text-muted"><?= $row["AdqFecCre"] ?></small></p>
                                </div>
                                <div class="col-auto">
                                    <a href="../../servicios/view/?id=<?= $row['AdqSerID'] ?>" class="btn btn-primary btn-sm"><em class="fas fa-chevron-right"></em></a>
                                </div>
                            </div>
                        </div>
                    </div>
